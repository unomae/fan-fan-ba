...
最後更新：2026-09-09 · <!-- ffb:suites -->27<!-- /ffb:suites --> suites / <!-- ffb:tests -->336<!-- /ffb:tests --> tests 全綠（0 failed、0 skipped）。
...
├── vocabulary-backup.test.js    # vocabulary-backup.js：JSON round-trip / merge / CSV / 匯入硬化

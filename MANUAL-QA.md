...
**進度（2026-08-10）：Tier 0、1 完成，Tier 2 完成 10/17 → 全表剩 60 項未跑。**
下一個是 **Tier 2 的後半**：跨裝置匯入 3 項 ＋ 零收穫匯入 4 項。
...
| **2** | 〈2026-07-30 單字本資料層〉 | 17 | 60 分 | 🔶 **10/17**（快照還原 7 ✅・DevTools 2 ✅＋1 跳過・**匯入 7 項待跑**）| 資料遺失類 |
